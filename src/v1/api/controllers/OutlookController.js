...
class OutlookController {
  ...
  async getAccessToken(req, res) {
    try {
      ...
      return responseHelper.success(res, 'outlook_access_token', tokenData);
    } catch (error) {
  ...
  async getRefreshToken(req, res) {
    try {
      ...
      return responseHelper.success(res, 'outlook_refresh_token', tokenData);
    } catch (error) {
      return responseHelper.error(res, error.message || 'INTERNAL_SERVER_ERROR', error.code || 500);
    }
  }
  ...
  async getCalenderList(req, res) {
    try {
      ...
      return responseHelper.success(res, 'outlook_calender_list', calenderList);
    } catch (error) {
      return responseHelper.error(res, error.message || 'INTERNAL_SERVER_ERROR', error.code || 500);
    }
  }
  ...
  async getCalenderEvents(req, res) {
    try {
      ...
      return responseHelper.success(res, 'outlook_calender_events', calenderList);
    } catch (error) {
